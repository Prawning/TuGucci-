<template>
    <div class="main_quest lg:w-[70vw] lg:h-[70vh] h-[50vh] w-[90vw] flex flex-col items-center justify-center" >
        ...
        <div @click=reset_page class="absolute w-20 h-20 lg:top-10 lg:right-10 md:top-10 md:right-10 bottom-10 left-10 rounded-xl lg:text-3xl text-lg font-secondary text-quaternary exit lg:p-10 p-2">
            Redo Quiz!
        </div>
    </div>
</template>
